...
struct_of_ints* add_to_list      (struct_of_ints *head_pointer, int value) ;
struct_of_ints* search_list      (struct_of_ints *head_pointer, int value) ;
struct_of_ints* delete_from_list (struct_of_ints *head_pointer, int value) ;
struct_of_ints* delete_list      (struct_of_ints *head_pointer) ;
void            print_list       (struct_of_ints *head_pointer) ;
